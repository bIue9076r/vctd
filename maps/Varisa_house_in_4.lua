...
World.Map[11]:setTile(11,6,BigTable_B)
World.Map[11]:setTile(11,5,BigTable_T)
...
World.Map[11]:addWall(Box.new(12,3.8,2,0.3))
World.Map[11]:addWall(Box.new(20.4,8.88,1.6,2))
