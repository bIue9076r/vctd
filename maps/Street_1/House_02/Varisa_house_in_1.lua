...
World.Map[8]:addProp(Prop.new(8,12.5,Vase2))
World.Map[8]:addProp(Prop.new(13,12.5,Vase2))
World.Map[8]:addProp(Prop.new(8,11.5,Flowers_2,1))
World.Map[8]:addProp(Prop.new(13,11.5,Flowers_2,1))

World.Map[8]:addProp(Prop.new(8,1.5,Vase2))
World.Map[8]:addProp(Prop.new(13,1.5,Vase2))
World.Map[8]:addProp(Prop.new(8,0.5,Flowers_2,1))
World.Map[8]:addProp(Prop.new(13,0.5,Flowers_2,1))
