...
World.Map[3]:addWall(Box.new(10,4,0.1,6))
World.Map[3]:addWall(Box.new(8,4,2,0.1))

World.Map[3]:addWall(Box.new(18.4,6.88,1.6,2))

World.Map[3]:addWall(Box.new(14.9,7.1,1.8,0.1))
World.Map[3]:addWall(Box.new(14.9,7.1,0.5,2.2))
World.Map[3]:addWall(Box.new(14.9,9.3,1.8,0.1))
