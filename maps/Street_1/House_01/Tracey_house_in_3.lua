...
World.Map[4]:addProp(Prop.new(20,2,Bed_1_1,1,1))
World.Map[4]:addProp(Prop.new(21,2,Bed_1_2,1,1))
World.Map[4]:addProp(Prop.new(20,3,Bed_1_3,1,1))
World.Map[4]:addProp(Prop.new(21,3,Bed_1_4,1,1))
World.Map[4]:addProp(Prop.new(20,4,Bed_1_5,1,1))
World.Map[4]:addProp(Prop.new(21,4,Bed_1_6,1,1))

World.Map[4]:addWall(Box.new(20,3.8,2,0.3))
...
World.Map[4]:addNpc(Npc.new(21.0,2.5,Interaction,-22,0,function()
