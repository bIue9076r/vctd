...
World.Map[15]:addProp(Prop.new(15.7,9,Couch_6,1,1))
World.Map[15]:addProp(Prop.new(15.7,8,Couch_4,1,1))
World.Map[15]:addProp(Prop.new(15.7,7,Couch_2,1,1))

World.Map[15]:addProp(Prop.new(14.7,9,Couch_5,1,1))
World.Map[15]:addProp(Prop.new(14.7,8,Couch_3,1,1))
World.Map[15]:addProp(Prop.new(14.7,7,Couch_1,1,1))
...
World.Map[15]:addWall(Box.new(18.4,6.88,1.6,2))

World.Map[15]:addWall(Box.new(14.9,7.1,1.8,0.1))
World.Map[15]:addWall(Box.new(14.9,7.1,0.5,2.2))
World.Map[15]:addWall(Box.new(14.9,9.3,1.8,0.1))
