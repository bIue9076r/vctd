...
World.Map[15]:addProp(Prop.new(15.7,9,Couch_6,1))
World.Map[15]:addProp(Prop.new(15.7,8,Couch_4,1))
World.Map[15]:addProp(Prop.new(15.7,7,Couch_2,1))

World.Map[15]:addProp(Prop.new(14.7,9,Couch_5,1))
World.Map[15]:addProp(Prop.new(14.7,8,Couch_3,1))
World.Map[15]:addProp(Prop.new(14.7,7,Couch_1,1))
