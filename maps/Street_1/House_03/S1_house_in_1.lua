...
if House.house[1].HouseTrait == "Neat" then
	World.Map[14]:addProp(Prop.new(8,12.5,Vase3))
	World.Map[14]:addProp(Prop.new(13,12.5,Vase3))
	World.Map[14]:addProp(Prop.new(8,11.5,Flowers_3,1))
	World.Map[14]:addProp(Prop.new(13,11.5,Flowers_3,1))
	
	World.Map[14]:addProp(Prop.new(8,1.5,Vase3))
	World.Map[14]:addProp(Prop.new(13,1.5,Vase3))
	World.Map[14]:addProp(Prop.new(8,0.5,Flowers_3,1))
	World.Map[14]:addProp(Prop.new(13,0.5,Flowers_3,1))
