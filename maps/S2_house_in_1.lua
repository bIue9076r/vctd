...
World.Map[22]:addWall(Box.new(6,4,2,6))
World.Map[22]:addWall(Box.new(6,0,2,2))
World.Map[22]:addWall(Box.new(14,0,8,4))
--World.Map[22]:addWall(Box.new(16,4,6,0.5))
World.Map[22]:addWall(Box.new(14,4,2,4))
World.Map[22]:addWall(Box.new(14,10,2,4))
World.Map[22]:addWall(Box.new(0.4,2.88,1.6,2))
