...
World.Map[6]:addProp(Prop.new(10.8,2.9+3,Sand_R,1,1))
World.Map[6]:addProp(Prop.new(10.8+1,2.9+3,Sand,1,1))
World.Map[6]:addProp(Prop.new(10.8+2,2.9+3,Sand,1,1))
World.Map[6]:addProp(Prop.new(10.8+3,2.9+3,Sand,1,1))
World.Map[6]:addProp(Prop.new(10.8+4,2.9+3,Sand,1,1))
World.Map[6]:addProp(Prop.new(10.8+5,2.9+3,Sand,1,1))
World.Map[6]:addProp(Prop.new(10.8+6,2.9+3,Sand_L,1,1))
