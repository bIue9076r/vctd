...
World.Map[4]:addProp(Prop.new(20,2,Bed_1_1))
World.Map[4]:addProp(Prop.new(21,2,Bed_1_2))
World.Map[4]:addProp(Prop.new(20,3,Bed_1_3))
World.Map[4]:addProp(Prop.new(21,3,Bed_1_4))
World.Map[4]:addProp(Prop.new(20,4,Bed_1_5))
World.Map[4]:addProp(Prop.new(21,4,Bed_1_6))
