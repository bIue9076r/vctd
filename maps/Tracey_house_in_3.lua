...
World.Map[4]:addProp(Prop.new(17,5,ERROBJ,1))
World.Map[4]:addProp(Prop.new(18,5,ERROBJ,1))
World.Map[4]:addProp(Prop.new(17,6,ERROBJ,1))
World.Map[4]:addProp(Prop.new(18,6,ERROBJ,1))

World.Map[4]:addProp(Prop.new(11,11,ERROBJ,1))
World.Map[4]:addProp(Prop.new(12,11,ERROBJ,1))
World.Map[4]:addProp(Prop.new(11,12,ERROBJ,1))
World.Map[4]:addProp(Prop.new(12,12,ERROBJ,1))

World.Map[4]:addProp(Prop.new(18,10,ERROBJ,1))
World.Map[4]:addProp(Prop.new(19,10,ERROBJ,1))
World.Map[4]:addProp(Prop.new(18,11,ERROBJ,1))
World.Map[4]:addProp(Prop.new(19,11,ERROBJ,1))
