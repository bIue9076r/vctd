...
World.Map[2]:addProp(Prop.new(8,12.5,Vase))
World.Map[2]:addProp(Prop.new(13,12.5,Vase))
World.Map[2]:addProp(Prop.new(8,11.5,Flowers,1))
World.Map[2]:addProp(Prop.new(13,11.5,Flowers,1))

World.Map[2]:addProp(Prop.new(8,1.5,Vase))
