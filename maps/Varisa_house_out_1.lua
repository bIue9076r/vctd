...
World.Map[8]:setTile(1,7,Road_T)
World.Map[8]:setTile(2,7,Road_N_T)
World.Map[8]:setTile(3,7,Road_T)
World.Map[8]:setTile(4,7,Road_N_T)
World.Map[8]:setTile(5,7,Road_T)
World.Map[8]:setTile(6,7,Road_N_T)
World.Map[8]:setTile(7,7,Road_T)
World.Map[8]:setTile(8,7,Road_N_T)
World.Map[8]:setTile(9,7,Road_T)
World.Map[8]:setTile(10,7,Road_N_T)
World.Map[8]:setTile(11,7,Road_T)
