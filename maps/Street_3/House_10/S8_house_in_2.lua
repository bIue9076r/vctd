...
World.Map[63]:addProp(Prop.new(15.7,9,ERROBJ,1))
World.Map[63]:addProp(Prop.new(15.7,8,ERROBJ,1))
World.Map[63]:addProp(Prop.new(15.7,7,ERROBJ,1))
World.Map[63]:addProp(Prop.new(15.7,6,ERROBJ,1))

World.Map[63]:addProp(Prop.new(14.7,9,ERROBJ,1))
World.Map[63]:addProp(Prop.new(14.7,8,ERROBJ,1))
World.Map[63]:addProp(Prop.new(14.7,7,ERROBJ,1))
World.Map[63]:addProp(Prop.new(14.7,6,ERROBJ,1))
