...
World.Map[75]:addProp(Prop.new(15.7,9,Couch_6,1,1))
World.Map[75]:addProp(Prop.new(15.7,8,Couch_4,1,1))
World.Map[75]:addProp(Prop.new(15.7,7,Couch_2,1,1))

World.Map[75]:addProp(Prop.new(14.7,9,Couch_5,1,1))
World.Map[75]:addProp(Prop.new(14.7,8,Couch_3,1,1))
World.Map[75]:addProp(Prop.new(14.7,7,Couch_1,1,1))
...
World.Map[75]:addWall(Box.new(14.9,7.1,1.8,0.1))
World.Map[75]:addWall(Box.new(14.9,7.1,0.5,2.2))
World.Map[75]:addWall(Box.new(14.9,9.3,1.8,0.1))
...
if House.house[10].HouseTrait == "Neat" then
	World.Map[75]:addProp(Prop.new(20.5,12.5,Vase3))
	World.Map[75]:addProp(Prop.new(20.5,11.5,Flowers_3,1))
	
	World.Map[75]:addProp(Prop.new(20.5,3,Vase3))
	World.Map[75]:addProp(Prop.new(20.5,2,Flowers_3,1))
end
...
if House.house[10].HouseTrait == "Messy" then
	...
	World.Map[75]:addProp(Prop.new(20.5,12.5,Vase3_C))
	World.Map[75]:addProp(Prop.new(20.5,3,Vase3_C))
end
