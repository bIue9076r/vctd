...
World.Dialogue[English][1] = Dialogue.new({
	Text.newAnimated("Hey",Varisa,3),
	Text.newAnimatedLeft("Hey Var!",Tracey,1),
	Text.newAnimated("Does your mom still have any cookies?",Varisa,2),
	Text.newAnimatedLeft("Should be some inside",Tracey,1),
	Text.newAnimated("Sweet!",Varisa,3),
},0,function()
...
World.Dialogue[English][18] = Dialogue.new({
	...
	Text.newAnimated("Hey.",Varisa,2),
	Text.newAnimatedLeft("What brings you over here today?",Wilkie,0),
	Text.newAnimated("Mrs. Fisher said you had her toolbox.",Varisa,3),
	Text.newAnimatedLeft("Yes, it's in my room",Wilkie,1),
	Text.newAnimated("Oh great.",Varisa,3),
	Text.newAnimated("I just need something from it.",Varisa,2),
...
World.Dialogue[English][23] = Dialogue.new({
	...
	Text.newAnimatedLeft("Hey.",Varisa),
	Text.newAnimatedLeft("Do you know where the toolbox is?",Varisa),
	Text.newAnimated("I think i gave it to Wilkie a few days ago...",Lassie,1),
	Text.newAnimatedLeft("Oh.",Varisa),
...
World.Dialogue[English][24] = Dialogue.new({
	Text.newAnimated("What is the matter?",Fredrick),
	Text.newAnimatedLeft("Hey...",Varisa),
	Text.newAnimated("Yes?",Fredrick),
	Text.newAnimatedLeft("You know my mom right?",Varisa),
	Text.newAnimated("Who are you, again?",Fredrick),
	Text.newAnimatedLeft("Varisa Carmel.... The girl that-",Varisa),
	Text.newAnimated("Threw eggs at my house.",Fredrick),
	Text.newAnimated("Oh yeah, I remember you...",Fredrick),
	Text.newAnimated("Why aren't you still in jail?",Fredrick),
	Text.newAnimatedLeft("Cause that happened when I was 12.",Varisa),
	Text.newAnimatedLeft("It's been like 7 years...",Varisa),
	Text.newAnimatedLeft("I thought you'd remember me because...",Varisa),
	Text.newAnimatedLeft("I help Wilkie a lot",Varisa),
	...
	Text.newAnimated("So you're not completely terrible",Fredrick),
	Text.newAnimatedLeft("Perhaps.",Varisa),
	Text.newAnimated("Anyway, would you like to exercise with me?",Fredrick),
	Text.newAnimatedLeft("What?",Varisa),
	Text.newAnimated("You know, moving around.",Fredrick),
	Text.newAnimated("It helps keep the body in shape.",Fredrick),
	Text.newAnimatedLeft("I guess...",Varisa,1,nil,function()
		Story.set("Fredrick_Exercise_1",true)
	end),
	Text.newAnimated("At least pretend to use the jump rope I gave you.",Fredrick),
},1)

World.Dialogue[English][25] = Dialogue.new({
	Text.newAnimated("Hello Varisa.",Vivian),
},1)

World.Dialogue[English][26] = Dialogue.new({
	Text.newAnimated("Varisa?",Sean),
	Text.newAnimatedLeft("Hey...",Varisa),
},1)

World.Dialogue[English][27] = Dialogue.new({
	Text.newAnimated("Who the hell are you?",Ella),
},1)

World.Dialogue[English][28] = Dialogue.new({
	Text.newAnimated("Hey Varisa...",Brian,0),
	Text.newAnimatedLeft("Uhh... Yeah.",Varisa),
	...
	Text.newAnimatedLeft("But aren't you just standing around?",Varisa),
	Text.newAnimated("I'm very busy, you wouldn't understand.",Brian,0),
	Text.newAnimatedLeft("Yeah me too.",Varisa),
	Text.newAnimated("Too busy for 150?",Brian,1),
	Text.newAnimatedLeft("You're bluffing.",Varisa),
	Text.newAnimated("Your loss, I guess.",Brian,0),
	Text.newAnimatedLeft("Where's the trash?",Varisa),
...
World.Dialogue[English][29] = Dialogue.new({
	...
	Text.newAnimatedLeft("Yeah, it's right here.",Varisa),
...
World.Dialogue[English][30] = Dialogue.new({
	Text.newAnimated("Did you get the toolbox?",Rachel,1),
	Text.newAnimatedLeft("No but our old math teacher gave me this.",Varisa),
	Text.newAnimated("No way!",Rachel,1),
	Text.newAnimated("That's exactly what I need!",Rachel,1),
	Text.newAnimatedLeft("Well, that works I guess.",Varisa),
...
World.Dialogue[English][31] = Dialogue.new({
	Text.newAnimated("Did you get the toolbox?",Rachel,1),
	Text.newAnimatedLeft("Wilkie's still using it.",Varisa),
	Text.newAnimatedLeft("But he'll let us borrow the tool you need.",Varisa),
	Text.newAnimated("Okay.",Rachel,1),
	Text.newAnimated("Ask him for the screwdriver.",Rachel,1),
	Text.newAnimatedLeft("Screwdriver?",Varisa),
	Text.newAnimatedLeft("Yeah?",Varisa),
	Text.newAnimatedLeft("Look what our old math teacher gave me.",Varisa),
	Text.newAnimated("No way!",Rachel,1),
	Text.newAnimated("That's exactly what I need!",Rachel,1),
	Text.newAnimatedLeft("Well, that works I guess.",Varisa),
	Text.newAnimated("Here, take my guitar.",Rachel,1,nil,function()
...
World.Dialogue[English][32] = Dialogue.new({
	...
	Text.newAnimated("Great.",Rachel,1),
	Text.newAnimated("I need you to ask my mom for the toolbox.",Rachel,1),
	Text.newAnimatedLeft("Wait, what do you need from it?",Varisa),
...
World.Dialogue[English][33] = Dialogue.new({
	Text.newAnimatedLeft("There's a lot more people than usual.",Tracey,1),
	Text.newAnimated("You could say.",Varisa,3),
	Text.newAnimatedLeft("What's Mollie doing at the park",Tracey,1),
	Text.newAnimated("Playing in the sand?",Varisa,2),
	Text.newAnimatedLeft("Isn't she like what, 82?",Tracey,1),
	Text.newAnimated("27.",Varisa,3),
	Text.newAnimatedLeft("Wouldn't books be more her style?",Tracey,1),
	Text.newAnimated("English teachers can do other things...",Varisa,2),
	Text.newAnimatedLeft("Like?",Tracey,1),
	Text.newAnimated("Playing in the sand.",Varisa,3),
	Text.newAnimatedLeft("...",Tracey,1),
},1)

World.Dialogue[English][34] = Dialogue.new({
	Text.newAnimated("Stay away from me.",Fredrick),
	Text.newAnimatedLeft("Geez, sorry.",Varisa),
	Text.newAnimated("...",Fredrick),
},1)
...
World.Dialogue[English][35] = Dialogue.new({
	...
	Text.newAnimated("Looking for my mother.",Varisa,2),
	Text.newAnimatedLeft("Oh dear, she's still missing?",Wilkie,0),
	Text.newAnimated("Yeah...",Varisa,2),
	Text.newAnimatedLeft("I hope you find her soon.",Wilkie,0),
	Text.newAnimated("I'm trying...",Varisa,3),
...
World.Dialogue[English][36] = Dialogue.new({
	...
	Text.newAnimatedLeft("But you don't even teach me anymore?",Varisa),
	Text.newAnimated("So why are you bothering me right now?",Mollie,0),
	Text.newAnimatedLeft("Cause I need your help.",Varisa),
	...
	Text.newAnimatedLeft("Sure.",Varisa),
	Text.newAnimatedLeft("So what are you doing in the sand?",Varisa),
	Text.newAnimated("I dunno, something distract me from them...",Mollie,0),
	Text.newAnimatedLeft("Who?",Varisa),
	Text.newAnimated("Sean and that... bitch.",Mollie,0),
	Text.newAnimatedLeft("You have to be specific, I know several.",Varisa),
	Text.newAnimated("You know that one with the pink hair?",Mollie,0),
	Text.newAnimatedLeft("Yeah, I think?",Varisa),
	Text.newAnimatedLeft("Isn't she a teacher?",Varisa),
	Text.newAnimated("She couldn't teach even if she wanted to.",Mollie,0),
	Text.newAnimatedLeft("Intresting...",Varisa),
	...
	Text.newAnimatedLeft("Uh...",Varisa),
	Text.newAnimated("What?",Mollie,0),
	Text.newAnimatedLeft("Don't tell me you watched them the WHOLE time.",Varisa),
	Text.newAnimated("Well how else would I have found out?",Mollie,0),
	Text.newAnimatedLeft("So, lets get this straight.",Varisa),
	Text.newAnimatedLeft("He dumped you to get with your best friend.",Varisa),
	Text.newAnimated("FORMER!",Mollie,0),
	Text.newAnimatedLeft("Okay, former best friend.",Varisa),
	Text.newAnimated("And you're going to help me break them up.",Mollie,1),
	Text.newAnimatedLeft("What?",Varisa),
	Text.newAnimated("Yes, what's the matter?",Mollie,0),
	Text.newAnimatedLeft("I dunno, that seems like quite a leap.",Varisa),
	Text.newAnimated("You just said you'd help me earlier",Mollie,0),
	Text.newAnimatedLeft("How am I supposed to do that?",Varisa),
...
World.Dialogue[English][37] = Dialogue.new({
	...
	Text.newAnimatedLeft("Yeah............",Varisa),
	Text.newAnimatedLeft("Wait?",Varisa),
	Text.newAnimatedLeft("What did you say?",Varisa),
	...
	Text.newAnimatedLeft("What the fuck is wrong with you?!",Varisa),
	Text.newAnimated("I'm just telling you the truth.",Mollie,0),
	Text.newAnimatedLeft("Maybe being an asshole is just natural to you.",Varisa),
	Text.newAnimated("Fuck off.",Mollie,0),
},1)

World.Dialogue[English][38] = Dialogue.new({
	Text.newAnimated("You done, twerp?",Mollie,0),
	Text.newAnimatedLeft("Yep.",Varisa),
	Text.newAnimated("What did you find?",Mollie,0),
	Text.newAnimatedLeft("An engagement ring.",Varisa),
	Text.newAnimated("Seriously?",Mollie,0),
	Text.newAnimatedLeft("Yeah.",Varisa),
	Text.newAnimated("Screw me I guess.",Mollie,0),
	Text.newAnimatedLeft("You could try therapy.",Varisa),
...
World.Dialogue[English][41] = Dialogue.new({
	...
	Text.newAnimatedLeft("Uhh I'm not looking at you weird?",Varisa),
	Text.newAnimated("I'd appreciate it if you left.",Ella,0),
	Text.newAnimatedLeft("Alright I guess.",Varisa),
...
World.Dialogue[English][42] = Dialogue.new({
	...
	Text.newAnimatedLeft("You weren't before?",Varisa),
...
World.Dialogue[English][43] = Dialogue.new({
	Text.newAnimated("Go away.",Fredrick),
},1)
...
World.Dialogue[English][44] = Dialogue.new({
	...
	Text.newAnimatedLeft("More fire and brimstone?",Varisa),
	Text.newAnimated("Not necessarily, but...",Karina,0),
	Text.newAnimated("Everyone here is a sicko.",Karina,0),
	Text.newAnimatedLeft("And you wonder why people hate you.",Varisa),
	Text.newAnimated("It's persecution I say.",Karina,0),
	Text.newAnimatedLeft("Anything else new to say?",Varisa),
	Text.newAnimated("What more is there to say?",Karina,0),
	Text.newAnimatedLeft("What's that.",Varisa),
...
World.Dialogue[English][45] = Dialogue.new({
	...
	Text.newAnimatedLeft("What do you need?",Varisa),
...
World.Dialogue[English][49] = Dialogue.new({
	...
	Text.newAnimatedLeft("Help with what?",Varisa),
...
World.Dialogue[English][50] = Dialogue.new({
	...
	Text.newAnimatedLeft("It was out by Jami's house.",Varisa),
...
World.Dialogue[English][52] = Dialogue.new({
	...
	Text.newAnimatedLeft("Zoey's",Varisa),
	Text.newAnimated("Hmm... Intresting.",Jami,0),
	Text.newAnimatedLeft("So i'm gonna take it now...",Varisa),
...
World.Dialogue[English][56] = Dialogue.new({
	...
	Text.newAnimatedLeft("I have no idea.",Varisa),
	Text.newAnimated("Just stay CALM OKAY!",Zoey,0),
	Text.newAnimatedLeft("uhh..........",Varisa),
...
World.Dialogue[English][57] = Dialogue.new({
	...
	Text.newAnimatedLeft("What the hell is wrong with you?",Varisa),
	Text.newAnimated("Huh?",Jami,1),
	Text.newAnimated("It's just part of the method.",Jami,1),
	Text.newAnimatedLeft("Turn the lights back on.",Varisa),
	...
	Text.newAnimatedLeft("Is this why you had to cut the power?",Varisa),
	Text.newAnimated("Yes.",Jami,1),
	Text.newAnimatedLeft("You're insane.",Varisa),
	...
	Text.newAnimatedLeft("Fine....",Varisa),
...
World.Dialogue[English][58] = Dialogue.new({
	...
	Text.newAnimatedLeft("I don't have a 'bit'",Varisa),
...
World.Dialogue[English][59] = Dialogue.new({
	Text.newAnimatedLeft("I dunno.",Varisa),
	Text.newAnimated("It just showed up today for some reason.",Jami,0),
	Text.newAnimatedLeft("Odd.",Varisa),
...
World.Dialogue[English][64] = Dialogue.new({
	...
	Text.newAnimatedLeft("Cool.",Varisa),
...
World.Dialogue[English][65] = Dialogue.new({
	...
	Text.newAnimatedLeft("Same.",Varisa),
	Text.newAnimated("You should stay for the demonstration.",Zach,0),
	Text.newAnimatedLeft("Maybe.",Varisa),
...
World.Dialogue[English][66] = Dialogue.new({
	...
	Text.newAnimatedLeft("Nothing about the power?",Varisa),
	Text.newAnimated("Huh, what?",Mollie,0),
	Text.newAnimatedLeft("The reason why we're outside?",Varisa),
	Text.newAnimated("Oh the power.",Mollie,0),
	Text.newAnimatedLeft("...",Varisa),
...
World.Dialogue[English][67] = Dialogue.new({
	...
	Text.newAnimatedLeft("A day alright.",Varisa),
...
World.Dialogue[English][68] = Dialogue.new({
	...
	Text.newAnimatedLeft("The power?",Varisa),
...
World.Dialogue[English][69] = Dialogue.new({
	...
	Text.newAnimatedLeft("Yes.",Varisa),
...
World.Dialogue[English][70] = Dialogue.new({
	...
	Text.newAnimatedLeft("Yeah, but the power coming back would be nice.",Varisa),
},1)
...
World.Dialogue[English][71] = Dialogue.new({
	...
	Text.newAnimatedLeft("What plans?",Varisa),
...
World.Dialogue[English][72] = Dialogue.new({
	...
	Text.newAnimatedLeft("Yeah, the power coming back would be nice.",Varisa),
...
World.Dialogue[English][73] = Dialogue.new({
	...
	Text.newAnimatedLeft("Odd. Anything else out of the ordinary.",Varisa),
...
World.Dialogue[English][74] = Dialogue.new({
	Text.newAnimated("Is pudding day. Ja.",Fredrick),
	Text.newAnimatedLeft("Cool, but wasn't yesterday exercise day?",Varisa),
	Text.newAnimated("It's a German thing, you would not understand.",Fredrick),
	Text.newAnimatedLeft("Okay.",Varisa),
	...
	Text.newAnimatedLeft("Wow? You're being nice to me for once.",Varisa),
	Text.newAnimated("I suppose it's the least I can do.",Fredrick),
	Text.newAnimated("And with your mother gone.",Fredrick),
	Text.newAnimated("Enjoy the pudding.",Fredrick),
},1)
...
World.Dialogue[English][76] = Dialogue.new({
	...
	Text.newAnimatedLeft("Even with the lights out?",Varisa),
	Text.newAnimated("Yeah.",Karina,0),
	Text.newAnimatedLeft("Alright what is it?",Varisa),
...
World.Dialogue[English][77] = Dialogue.new({
	...
	Text.newAnimatedLeft("Thank you so much for the help.",Varisa),
	Text.newAnimatedLeft("You don't know how much this means to me.",Varisa),
...
World.Dialogue[English][79] = Dialogue.new({
	...
	Text.newAnimatedLeft("I mean.",Varisa),
	Text.newAnimated("...",Sean,0),
	Text.newAnimated("...",Sean,0),
	Text.newAnimated("You wouldn't mind paying her back a bit?",Sean,1),
	Text.newAnimatedLeft("I guess.",Varisa),
...
World.Dialogue[English][80] = Dialogue.new({
	...
	Text.newAnimatedLeft("I'm not.",Varisa),
...
World.Dialogue[English][81] = Dialogue.new({
	...
	Text.newAnimatedLeft("So the power?",Varisa),
...
World.Dialogue[English][82] = Dialogue.new({
	...
	Text.newAnimatedLeft("Ugh, I guess.",Varisa),
	...
	Text.newAnimatedLeft("Like what?",Varisa),
...
World.Dialogue[English][83] = Dialogue.new({
	...
	Text.newAnimatedLeft("Wasn't that ring enough?",Varisa),
	Text.newAnimated("I need more.",Mollie,1),
	Text.newAnimatedLeft("I suppose.",Varisa),
...
World.Dialogue[English][84] = Dialogue.new({
	Text.newAnimated("I need your help.",Karina,0),
	Text.newAnimatedLeft("I already turned on the lights.",Varisa),
...
World.Dialogue[English][86] = Dialogue.new({
	...
	Text.newAnimated("I guess.",Varisa,3),
...
World.Dialogue[English][88] = Dialogue.new({
	...
	Text.newAnimatedLeft("Can't you ask her?",Varisa),
...
World.Dialogue[English][90] = Dialogue.new({
	Text.newAnimated("Hey.",Lassie,0),
	Text.newAnimatedLeft("Hey, what sort of tapes do you have?",Varisa),
	Text.newAnimated("You want my tapes?",Lassie,1),
	Text.newAnimated("I don't recall watching anything you might like.",Lassie,1),
	Text.newAnimatedLeft("My mom wouldn't want to miss her shows.",Varisa),
	...
	Text.newAnimatedLeft("Thanks.",Varisa),
...
World.Dialogue[English][93] = Dialogue.new({
	...
	Text.newAnimatedLeft("I'm glad it went pretty okay.",Varisa),
	Text.newAnimatedLeft("I wonder when she's going to pay us.",Tracey,1),
	Text.newAnimatedLeft("We should get something nice tomorow.",Varisa),
...
World.Dialogue[English][104] = Dialogue.new({
	Text.newAnimatedLeft("Hey.",Varisa),
	Text.newAnimated("Hey.",Mollie),
},1)

World.Dialogue[English][105] = Dialogue.new({
	Text.newAnimatedLeft("Hey.",Varisa),
	Text.newAnimated("Hey.",Fredrick),
},1)
...
World.Dialogue[English][107] = Dialogue.new({
	Text.newAnimated("MOM!",Varisa,2),
	Text.new("Mpfh...",Karly),
	Text.newAnimated("Let me get that off you.",Varisa,2),
	Text.new("Oh god...",Karly),
	Text.new("Where are they?",Karly),
	Text.newAnimated("Who are you talking about?",Varisa,2),
...
World.Dialogue[English][108] = Dialogue.new({
	...
	Text.new("Mpfh...",Karly),
	Text.new("Oh god...",Karly),
	Text.newAnimated("Vivian must have done this.",Varisa,2),
...
World.Dialogue[English][109] = Dialogue.new({
	...
	Text.newAnimatedLeft("For Vivian's birthday?",Varisa),
