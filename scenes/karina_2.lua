Play.Scenes[13] = Scene.new(World.Map[19])
Play.Scenes[13].tickGoal = 1220
Play.Scenes[13].Next = WORLD
Play.Scenes[13].Hour = Evening

Play.Scenes[13].Actors[1] = Actor.new(Mailbox,11.0,8.4)
Play.Scenes[13].Actors[2] = Actor.new(Mollie,9.9,8.2)
Play.Scenes[13].Actors[3] = Actor.new(Ella,16.6,9.6)
Play.Scenes[13].Actors[4] = Actor.new(Sean,18.3,9.6)
